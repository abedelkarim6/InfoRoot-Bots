...
def add_category(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] add_category failed")
...
def delete_category(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] delete_category failed")
        return {"status": "error", "message": str(e)}
...
def toggle_category(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] toggle_category failed")
        return {"status": "error", "message": str(e)}
...
def add_topic(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] add_topic failed")
        return {"status": "error", "message": str(e)}
...
def rename_topic(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] rename_topic failed")
        return {"status": "error", "message": str(e)}
...
def delete_topic(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] delete_topic failed")
        return {"status": "error", "message": str(e)}
...
def set_topic_catch_all(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] set_topic_catch_all failed")
        return {"status": "error", "message": str(e)}
...
def toggle_topic(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] toggle_topic failed")
        return {"status": "error", "message": str(e)}
...
def update_topic(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] update_topic failed")
        return {"status": "error", "message": str(e)}
...
def add_topic_schedule(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] add_topic_schedule failed")
        return {"status": "error", "message": str(e)}
...
def delete_topic_schedule(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] delete_topic_schedule failed")
        return {"status": "error", "message": str(e)}
...
def update_topic_schedule(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] update_topic_schedule failed")
        return {"status": "error", "message": str(e)}
...
def add_topic_keyword(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] add_topic_keyword failed")
        return {"status": "error", "message": str(e)}
...
def delete_topic_keyword(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] delete_topic_keyword failed")
        return {"status": "error", "message": str(e)}
...
def add_topic_keywords_bulk(request: Request, data: dict = Body(...)):
    try:
        ...
        logger.exception("[TOPIC] add_topic_keywords_bulk failed")
        return {"status": "error", "message": str(e)}
...
Example: ["keyword1", "keyword2", ...]"""
        ...
        logger.exception("[TOPIC] suggest_seos failed")
        return {"status": "error", "message": str(e)}
